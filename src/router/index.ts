...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/descriptiva/combinatoria-permutaciones',
      name: 'combinatoria-permutaciones',
      component: () => import('@/views/descriptive/CombinatoriaPermutacionesView.vue'),
    },
    {
      path: '/descriptiva/probabilidad',
      name: 'probabilidad',
